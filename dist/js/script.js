(function () {
    ...
    function menu() {
      ...
      var content = document.querySelector('.sidenav__bg'),
    ...
    */
    ...
    function animatedContent() {
      ...
      // animated contents
      const itemContent = gsapWithCSS.utils.toArray('.animated__content');
    ...
    function animatedTitles() {
      ...
      function setupSplits() {
        ...
        quotes.forEach(quote => {
          ...
          gsapWithCSS.set(quote.split.words, {
            position: 'static'
          });

          // Animation
          quote.anim = gsapWithCSS.from(quote.split.words, {
            scrollTrigger: {
              trigger: quote,
